...
public class ArtworkServiceTests {
    ...
    public void setMockOutput() {
        ...
        lenient().when(roomRepository.findById(2L)).thenAnswer(invocation -> {
        ...
        // Room 4 is a storage
        lenient().when(roomRepository.findById(4L)).thenAnswer(invocation -> {
    ...
    @Test public void testMoveArtworkToFullRoom() {
        ServiceLayerException exception = assertThrows(ServiceLayerException.class, () -> artworkService.moveArtworkToRoom(1, 3));
