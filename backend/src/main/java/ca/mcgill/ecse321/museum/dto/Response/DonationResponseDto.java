...
public class DonationResponseDto {
    ...
    public static Donation createModel(DonationResponseDto donationDto){
        ...
        if (donationDto.validator.getClass() == OwnerResponseDto.class)
            donation.setValidator(OwnerResponseDto.createModel((OwnerResponseDto) donationDto.validator));
        else
         ...
         if(donation.isValidated()) donation.setArtworks(ArtworkResponseDto.createModel(donationDto.artwork));
