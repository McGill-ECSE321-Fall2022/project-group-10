...
public class LoanResponseDto {
    ...
    public static LoanResponseDto createDto(Loan loan) {
        ...
        else if (loan.getValidator().getClass() == Administrator.class) loanDto.validator = OwnerResponseDto.createDto((Owner) loan.getValidator());
    ...
    public static Loan createModel(LoanResponseDto loanDto) {
        ...
        if (loanDto.validator.getClass() == OwnerResponseDto.class) loan.setValidator(OwnerResponseDto.createModel((OwnerResponseDto) loanDto.validator));
        else loan.setValidator(EmployeeResponseDto.createModel((EmployeeResponseDto) loanDto.validator));
