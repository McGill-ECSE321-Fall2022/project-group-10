...
public class MuseumSystem
{
  ...
  /* Code from template association_AddManyToOne */
  public Donation addDonation(int aId, boolean aValidated, String aDescription, Visitor aDonor, Artwork... allArtworks)
  {
    return new Donation(aId, aValidated, aDescription, this, aDonor, allArtworks);
  }
