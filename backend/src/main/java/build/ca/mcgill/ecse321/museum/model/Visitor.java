...
public class Visitor extends Person
{
  ...
  public Donation addDonation(int aId, boolean aValidated, String aDescription, MuseumSystem aMuseum, Artwork... allArtworks)
  {
    return new Donation(aId, aValidated, aDescription, aMuseum, this, allArtworks);
  }
